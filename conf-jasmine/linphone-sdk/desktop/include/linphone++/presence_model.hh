...
namespace linphone {
	...
	class PresenceModel: public Object {
		...
		public:
			 ...
			 * @return The LinphonePresenceBasicStatus of the #PresenceModel object given as
			 ...
			 * @brief Gets the capabilities of a #PresenceModel object. 
			 ...
			 * @return The timestamp of the #PresenceModel object or -1 on error. 
			 ...
			 * @brief Returns the version of the capability of a #PresenceModel. 
			 ...
			 * @return the version of the capability of a #PresenceModel or -1.0 if the model

			 * has not the capability. 
			 ...
			 * @brief Returns whether or not the #PresenceModel object has a given capability. 
			 ...
			 * @return whether or not the #PresenceModel object has a given capability. 
			 ...
			 * @return whether or not the #PresenceModel object has a given capability with a
