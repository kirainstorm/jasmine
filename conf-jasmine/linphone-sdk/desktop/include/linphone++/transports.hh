...
namespace linphone {
	...
	class Transports: public Object {
		...
		public:
			 ...
			 * @brief Gets the DTLS port in the #Transports object. 
			 ...
			 * @brief Sets the DTLS port in the #Transports object. 
			 ...
			 * @brief Gets the TCP port in the #Transports object. 
			 ...
			 * @brief Sets the TCP port in the #Transports object. 
			 ...
			 * @brief Gets the TLS port in the #Transports object. 
			 ...
			 * @brief Sets the TLS port in the #Transports object. 
			 ...
			 * @brief Gets the UDP port in the #Transports object. 
			 ...
			 * @brief Sets the UDP port in the #Transports object. 
