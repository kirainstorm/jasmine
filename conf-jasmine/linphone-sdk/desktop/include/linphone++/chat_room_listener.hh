...
namespace linphone {
	...
	class ChatRoomListener: public Listener {
		...
		public:
			...
			LINPHONECXX_PUBLIC virtual void onEphemeralEvent(const std::shared_ptr<linphone::ChatRoom> & cr, const std::shared_ptr<const linphone::EventLog> & eventLog) {};
			...
			LINPHONECXX_PUBLIC virtual void onEphemeralMessageTimerStarted(const std::shared_ptr<linphone::ChatRoom> & cr, const std::shared_ptr<const linphone::EventLog> & eventLog) {};
			...
			LINPHONECXX_PUBLIC virtual void onEphemeralMessageDeleted(const std::shared_ptr<linphone::ChatRoom> & cr, const std::shared_ptr<const linphone::EventLog> & eventLog) {};
