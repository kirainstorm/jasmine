...
namespace linphone {
	...
	class VideoDefinition: public Object {
		...
		public:
			 ...
			 * @brief Tells whether a #VideoDefinition is undefined. 

			 *

			 * @return A boolean value telling whether the #VideoDefinition is undefined. 
			 ...
			 * @brief Tells whether two #VideoDefinition objects are equal (the widths and the

			 * heights are the same but can be switched). 

			 *

			 * @param vdef2 #VideoDefinition object 

			 * 

			 * @return A boolean value telling whether the two #VideoDefinition objects are
			 ...
			 * @brief Tells whether two #VideoDefinition objects are strictly equal (the
