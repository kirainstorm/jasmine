...
namespace linphone {
	...
	class LoggingService: public MultiListenableObject {
		...
		public:
			...
			LINPHONECXX_PUBLIC void debug(const std::string & msg);
			...
			LINPHONECXX_PUBLIC void error(const std::string & msg);
			...
			LINPHONECXX_PUBLIC void fatal(const std::string & msg);
			...
			LINPHONECXX_PUBLIC void message(const std::string & msg);
			...
			LINPHONECXX_PUBLIC void trace(const std::string & msg);
			...
			LINPHONECXX_PUBLIC void warning(const std::string & msg);
