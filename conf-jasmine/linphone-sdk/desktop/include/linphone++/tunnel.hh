...
namespace linphone {
	...
	class Tunnel: public Object {
		...
		public:
			 ...
			 * @return  if tunnel is in use, false otherwise. 
			 ...
			 * @return  if dual tunnel client mode is enabled, false otherwise 
			 ...
			 * @param dualModeEnabled  to enable it, false to disable it 
