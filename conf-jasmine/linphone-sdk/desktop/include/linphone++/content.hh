...
namespace linphone {
	...
	class Content: public Object {
		...
		public:
			 ...
			 * @return A A list of #Content objects. LinphoneContent  The objects inside the
			 ...
			 *  object holding the part if found, nullptr otherwise. 
			 ...
			 * @return A #Content object object the part if found, nullptr otherwise. 
			 ...
			 * @return A #Content object holding the part if found, nullptr otherwise. 
