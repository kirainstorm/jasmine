...
namespace linphone {
	...
	class Core: public MultiListenableObject {
		...
		public:
			 ...
			 * @return  if the audio adaptive jitter compensation is enabled, false otherwise. 
			 ...
			 * @param enable  to enable the audio adaptive jitter compensation, false to
			 ...
			 * @return  if DNS search is enabled, false if disabled. 
			 ...
			 * @param enable  to enable DNS search, false to disable it. 
			 ...
			 * @return  if DNS was set by app, false otherwise. 
			 ...
			 * @return  if DNS SRV resolution is enabled, false if disabled. 
			 ...
			 * @param enable  to enable DNS SRV resolution, false to disable it. 
			 ...
			 * @return  if the echo limiter is enabled, false otherwise. 
			 ...
			 * @param val  to enable echo limiter, false to disable it. 
			 ...
			 * @brief Tells #Core to guess local hostname automatically in primary contact. 
			 ...
			 * @return  if it is required, false otherwise 
			 ...
			 * @return  if the local participant is in a conference, false otherwise. 
			 ...
			 * @return  if media encryption is mandatory; false otherwise. 
			 ...
			 * @param m  to set it mandatory; false otherwise. 
			 ...
			 * @return  if the microphone is enabled, false if disabled. 
			 ...
			 * @param enable  to enable the microphone, false to disable it. 
			 ...
			 * be stored, you have to set it after each #Core startup. 
			 ...
			 * have to set it after each #Core startup. 
			 ...
			 * @return  if the video adaptive jitter compensation is enabled, false otherwise. 
			 ...
			 * @param enable  to enable the video adaptive jitter compensation, false to
			 ...
			 * @return  if video capture is enabled, false if disabled. 
			 ...
			 * @param enable  to enable video capture, false to disable it. 
			 ...
			 * @return  if video display is enabled, false if disabled. 
			 ...
			 * @param enable  to enable video display, false to disable it. 
			 ...
			 * #Core to initiate future calls with video source reuse or not. Also, at the end

			 * of a video call, the source will be closed whatsoever for now. 

			 * 

			 * @param enable  to enable video source reuse. false to disable it for subsequent
			 ...
			 * @brief Adds authentication information to the #Core. 
			...
			LINPHONECXX_PUBLIC void audioRouteChanged();
			 ...
			 * The parameters are initialized according to the current #Core configuration and

			 * the current state of the LinphoneCall. 
			 ...
			 * @brief Create a new #NatPolicy by reading the config of a #Core according to

			 * the passed ref. 

			 *

			 * @param ref The reference of a NAT policy in the config of the #Core 
			 ...
			 * before answering. This can be achieved by calling deferCallUpdate() during the

			 * call state notification, to deactivate the automatic answer that would just

			 * confirm the audio but reject the video. Then, when the user responds to dialog

			 * prompt, it becomes possible to call acceptCallUpdate() to answer the reINVITE,

			 * with eventually video enabled in the #CallParams argument.
			 ...
			 * @brief Tells to #Core to use Linphone Instant Messaging encryption. 
			 ...
			 * @return  if it does, false otherwise 
			 ...
			 * @return  if crappy opengl flag is set, false otherwise 
			 ...
			 * @return whether a media encryption scheme is supported by the #Core engine 
			 ...
			 * #Core will then automatically unregister and place the proxy configuration on a

			 * deleted list. For that reason, a removed proxy does NOT need to be freed. 
			 ...
			 * @brief Start a #Core object after it has been instantiated and not
			 ...
			 * called only if LinphoneGlobalState is either Ready of Off. State will changed
			 ...
			 * @brief Stop a #Core object after it has been instantiated and started. 
			 ...
			 * @brief Stop asynchronously a #Core object after it has been instantiated and
			 ...
			 * State will change to Off. Must be called only if LinphoneGlobalState is On.

			 * When LinphoneGlobalState is Off #Core can be started again using start().
			 ...
			 * @param yesno  to use a separate window, false to insert the preview in the
...
;
			 ...
			 * @return  if VCARD is supported, false otherwise. 
