...
namespace linphone {
	...
	class Friend: public Object {
		...
		public:
			 ...
			 * @brief get current subscription policy for this #Friend 
			 ...
			 * @return  if presence information has been received for the friend, false
			 ...
			 * @brief Configure #Friend to subscribe to presence information. 
			 ...
			 * @return  if the friend is in a friend list, false otherwise. 
			 ...
			 * @return a new #Friend with vCard initialized  
