...
namespace linphone {
	...
	class CallParams: public Object {
		...
		public:
			 ...
			 * @brief Gets a list of #Content set if exists. 

			 *

			 * @return A list of #Content objects. LinphoneContent  A list of #Content set if
			 ...
			 * @brief Adds a #Content to be added to the INVITE SDP. 
			 ...
			 * @brief Copy an existing #CallParams object to a new #CallParams object. 

			 *

			 * @return A copy of the #CallParams object. 
