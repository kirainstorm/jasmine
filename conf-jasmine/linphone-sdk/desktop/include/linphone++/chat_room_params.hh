...
namespace linphone {
	...
	class ChatRoomParams: public Object {
		...
		public:
			 ...
			 * @return  if encryption is enabled, false otherwise 
			 ...
			 * @return  if group chat is enabled, false if one-to-one 
			 ...
			 * @return  if the given parameters are valid, false otherwise 
			 ...
			 * @return  if real time text is enabled, false otherwise 
