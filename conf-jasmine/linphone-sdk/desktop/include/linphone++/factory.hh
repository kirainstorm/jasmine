...
namespace linphone {
	...
	class Factory: public Object {
		...
		public:
			 ...
			 * @return  if the database storage is available, false otherwise 
			 ...
			 * @return  if the chatroom backend is available, false otherwise 
...
;
			 ...
			 * @brief Create the #Factory if that has not been done and return a pointer on

			 * it. 

			 *

			 * @return A pointer on the #Factory 
