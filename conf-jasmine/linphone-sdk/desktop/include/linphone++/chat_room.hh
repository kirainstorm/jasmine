...
namespace linphone {
	...
	class ChatRoom: public MultiListenableObject {
		...
		public:
			 ...
			 * automatically disappear from the recipient's screen after the message has been

			 * viewed. 

			 * 

			 * @param ephem  if the ephemeral message feature is enabled, false otherwise. 

			 */

			LINPHONECXX_PUBLIC void enableEphemeral(bool ephem);
			 ...
			 * @brief Returns whether or not a #ChatRoom has at least one #ChatMessage or not. 
			 ...
			 * @return  if the remote is currently composing a message, false otherwise. 
			 ...
			 * @brief get local address associated to  this #ChatRoom 
			 ...
			 * @brief get peer address associated to  this #ChatRoom 
