...
namespace linphone {
	...
	class ErrorInfo: public Object {
		...
		public:
			 ...
			 * @brief Assign phrase to a #ErrorInfo object. 
			 ...
			 * @brief Assign protocol name to a #ErrorInfo object. 
			 ...
			 * @brief Assign protocol code to a #ErrorInfo object. 
			 ...
			 * @brief Assign reason LinphoneReason to a #ErrorInfo object. 
			 ...
			 * @brief Assign retry-after value to a #ErrorInfo object. 
			 ...
			 * @brief Get pointer to chained #ErrorInfo set in sub_ei. 
			 ...
			 * @return #ErrorInfo pointer defined in the ei object. 
			 ...
			 * @brief Set the sub_ei in #ErrorInfo to another LinphoneErrorInfo. 
			 ...
			 * @param appendedEi #ErrorInfo to append 
			 ...
			 * @brief Assign warnings to a #ErrorInfo object. 
			 ...
			 * @brief Assign information to a #ErrorInfo object. 
