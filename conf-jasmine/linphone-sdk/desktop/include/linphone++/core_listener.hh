...
namespace linphone {
	...
	class CoreListener: public Listener {
		...
		public:
			 ...
			 * @param cr The LinphoneChatRoom object for which a message has expired. 

			 */

			LINPHONECXX_PUBLIC virtual void onChatRoomEphemeralMessageDeleted(const std::shared_ptr<linphone::Core> & lc, const std::shared_ptr<linphone::ChatRoom> & cr) {};
