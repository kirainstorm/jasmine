...
namespace linphone {
	...
	class ProxyConfig: public Object {
		...
		public:
			 ...
			 * @brief Get the #Core object to which is associated the #ProxyConfig. 

			 *

			 * @return The #Core object to which is associated the #ProxyConfig. 
			 ...
			 * @brief Get the dependency of a #ProxyConfig. 
			 ...
			 * @brief Get the idkey property of a #ProxyConfig. 
			 ...
			 * @param idkey The idkey string to associate to the given #ProxyConfig 
			 ...
			 * @brief Indicates either or not, PUBLISH must be issued for this #ProxyConfig. 
			 ...
			 * @return  if input is a phone number, false otherwise. 
