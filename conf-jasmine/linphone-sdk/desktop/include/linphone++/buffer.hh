...
namespace linphone {
	...
	class Buffer: public Object {
		...
		public:
			 ...
			 * @return A boolean value telling whether the #Buffer is empty or not. 
			 ...
			 * @brief Create a new #Buffer object from existing data. 
...
;
			 ...
			 * @brief Create a new #Buffer object from a string. 
