...
namespace linphone {
	...
	class FriendList: public MultiListenableObject {
		...
		public:
			 ...
			 * @brief Creates and export #Friend objects from #FriendList to a file using
			 ...
			 * @brief Creates and adds #Friend objects to #FriendList from a buffer that
			 ...
			 * @brief Creates and adds #Friend objects to #FriendList from a file that
