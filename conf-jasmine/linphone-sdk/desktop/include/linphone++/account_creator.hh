...
namespace linphone {
	...
	class AccountCreator: public MultiListenableObject {
		...
		public:
			 ...
			 * @return The activation code of the #AccountCreator 
			 ...
			 * @return The algorithm of the #AccountCreator 
			 ...
			 * @return The display name of the #AccountCreator 
			 ...
			 * @return The domain of the #AccountCreator 
			 ...
			 * @return The email of the #AccountCreator 
			 ...
			 * @return The ha1 of the #AccountCreator 
			 ...
			 * @return The language of the #AccountCreator 
			 ...
			 * @return The password of the #AccountCreator 
			 ...
			 * @return The phone number of the #AccountCreator 
			 ...
			 * @return The route of the #AccountCreator 
			 ...
			 * @return The set_as_default of the #AccountCreator 
			 ...
			 * @return The transport of #AccountCreator 
			 ...
			 * @return The username of the #AccountCreator 
