...
namespace linphone {
	...
	class Address: public Object {
		...
		public:
			 ...
			 * @brief Compare two #Address taking the tags and headers into account. 
			 ...
			 * @return Boolean value telling if the #Address objects are equal. 
			 ...
			 * @brief Compare two #Address ignoring tags and headers, basically just domain,
