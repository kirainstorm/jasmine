...
namespace linphone {
	...
	class Config: public Object {
		...
		public:
			 ...
			 * @brief Dumps the #Config as INI into a buffer. 
			 ...
			 * @brief Dumps the #Config as XML into a buffer. 
			 ...
			 * @return  if the value is successfully parsed as a range, false otherwise. If

			 * false is returned, min and max are filled respectively with default_min and
			 ...
			 * @brief Reads a xml config file and fill the #Config with the read config

			 * dynamic values. 

			 *

			 * @param filename The filename of the config file to read to fill the #Config 
			 ...
			 * @brief Reads a xml config string and fill the #Config with the read config

			 * dynamic values. 

			 *

			 * @param buffer The string of the config file to fill the #Config 
			 ...
			 * @brief Reads a user config file and fill the #Config with the read config
			 ...
			 * @brief Instantiates a #Config object from a user provided buffer. 
			 ...
			 * @param buffer the buffer from which the #Config will be retrieved. We expect
...
;
			 ...
			 * @brief Instantiates a #Config object from a user config file and a factory
