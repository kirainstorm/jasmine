...
namespace linphone {
	...
	class ChatMessage: public MultiListenableObject {
		...
		public:
			 ...
			 * @return the original sender of the message if it has been forwarded, null
			 ...
			 * @brief Returns true if the chat message is an ephemeral message. 
			 ...
			 * @brief Start the download of the #Content referenced in the #ChatMessage from
			 ...
			 * @brief Start the download of the file referenced in a #ChatMessage from remote
			 ...
			 * on the #ChatMessage instead of totaly takes ownership on it. Thus, the
